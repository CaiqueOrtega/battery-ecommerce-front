...
function ConfirmChanges({ showConfirmChangesModal, setShowConfirmChangesModal, action, handleConfirmChanges }) {
    ...
    return (
        <Modal show={showConfirmChangesModal} onHide={() => setShowConfirmChangesModal(false)} backdrop='false' centered>
            ...
            <Modal.Footer>
                ...
                <Button variant="red" onClick={() => handleConfirmChanges()}>Confirmar</Button>
            </Modal.Footer>
        </Modal>
    );
}
